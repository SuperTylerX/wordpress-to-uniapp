    ...
    <view class="uni-data-tree-input" @click="handleInput">
      <slot :options="options" :data="inputSelected" :error="errorMessage">
        <view class="input-value" :class="{ 'input-value-border': border }">
          ...
          <scroll-view v-else-if="inputSelected.length" class="selected-area" scroll-x="true">
            <view class="selected-list">
              <view v-for="(item, index) in inputSelected" :key="index" class="selected-item">
                ...
                ><text v-if="index < inputSelected.length - 1" class="input-split-line">{{
                  split
                }}</text>
              </view>
            </view>
          ...
          <view v-if="(!clearIcon || !inputSelected.length) && !readonly" class="arrow-area">
            <view class="input-arrow"></view>
          </view>
        </view>
      </slot>
    </view>
    <view v-if="isOpened" class="uni-data-tree-cover" @click="handleClose"></view>
    <view v-if="isOpened" class="uni-data-tree-dialog">
