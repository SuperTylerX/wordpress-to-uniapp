...
// #endif
const plugins=[require('./markdown/index.js'),require('./audio/index.js'),require('./emoji/index.js'),require('./highlight/index.js'),require('./style/index.js'),require('./img-cache/index.js'),]
